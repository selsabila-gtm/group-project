 ...
 * task_type: NER
 *
 * Entity types come from config.entity_types (organizer-configured).
 * If the organizer has seeded source texts, a PromptCard appears so the
 * contributor can load a passage with one click instead of typing their own.
 */
...
export default function NERWidget({ competition, config, prompt, promptLoading, onSubmit, submitting }) {
  ...
  const handleMouseUp = () => {
    ...
    const overlaps = entities.some((e) => !(actualEnd <= e.start || actualStart >= e.end));
  ...
  return (
    <div className="dc-widget">
      ...
      <PromptCard
        ...
        hint="Tag entities in the passage below, or write your own text."
